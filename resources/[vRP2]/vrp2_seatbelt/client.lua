...
Citizen.CreateThread(function()
	RegisterNetEvent('vrp2:Sound:PlayOnOne')
	AddEventHandler('vrp2:Sound:PlayOnOne', function(soundFile, soundVolume, loop)
	    SendNUIMessage({
	...
	RegisterNetEvent('vrp2:Sound:StopOnOne')
	AddEventHandler('vrp2:Sound:StopOnOne', function()
	    SendNUIMessage({
		...
		if car ~= 0 and (wasInCar or IsCar(car)) then
			...
			if speedBuffer[2] ~= nil 
			   ...
			   and (speedBuffer[2] - speedBuffer[1]) > (speedBuffer[1] * Cfg.DiffTriggertonto) then
					...
					TriggerEvent("vrp2:Sound:PlayOnOne","tonto",0.7,true)						
					...
					TriggerEvent("vrp2:Sound:StopOnOne")	
			end			
