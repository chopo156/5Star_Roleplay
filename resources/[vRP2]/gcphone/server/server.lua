...
FixePhone = {
  -- Poste de police
  ['190'] = { name =  "Centralt politi", coords = { x = 438.78359985352, y = -979.37890625, z = 31.8932762146 } },
  
  -- Cabine proche du poste de police
  ['0800'] = { name = "Offentlig telefon", coords = { x = 56.091968536377, y = -1079.8098144531, z = 29.45471572876 } },
}
...
function vRPgcphone.tunnel:vrp_addons_gcphone_startCall(number, message, coords)
  user = vRP.users_by_source[source]
  vRP.EXT.Base.remote._notify(user.source,"Dit opkald blev bedt om at "..number)
...
AddEventHandler('gcPhone:twitter_newTweets', function (tweet)
  local discord_webhook = GetConvar('discord_webhook', 'https://discord.com/api/webhooks/812369032874819626/aAngjYeFhqM-MNxgYnWFa4s_AfSv3PheptEDsJtnWlcM77iIi0oL8yyGOPSYc4jaH4EE')  if discord_webhook == '' then
    return
  end
  local headers = {
